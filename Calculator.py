...
def search():
    ...
    request_question = navegador.find_element_by_xpath('/html/body/div[7]/div/header/div/div/div/div/div/nav/div[3]/button/span')
    request_question.click()
    input_question = navegador.find_element_by_xpath('/html/body/div[3]/div/div[1]/div/header/div/div/div[2]/div/form/div/input')
    input_question.click()
    input_question.send_keys(record_question)
    get_question = navegador.find_element_by_xpath('/html/body/div[3]/div/div[1]/div/header/div/div/div[2]/div/form/div/button/div/svg')
    get_question.click()
